...
def genbibleverseimage(Book,Chapter,Verse,imgwidth,imgheight,numchars,imgtag,fontsize,gentxt):
...
if __name__ == '__main__':
    ...
    for Chapter in range(startchp,startchp+numchps):
        ...
        for verse in range(1,numverses+1):
            ...
            genbibleverseimage(Book,Chapter,Verse,instastorywidth,instastoryheight,instastorynumchars,imgtag,instastoryfontsize,gentxt)
